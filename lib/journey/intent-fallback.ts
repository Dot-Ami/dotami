...
const TAG_SYNONYMS: Record<ActivityTag, string[]> = {
  ...
  Trades: [
    ...
    "contractor", "roofing", "painting", "woodwork", "furniture", "handyman", "mechanic", "repair",
  ],
  "Content / streaming": [
...
/**
 * Most synonyms intentionally match a stem ("carpent" -> "carpenter"). Very short
 * synonyms are different: matching them inside another word turns ordinary language into
 * a false signal ("ai" -> "repair", "car" -> "carpenter", "van" -> "advance").
 */
